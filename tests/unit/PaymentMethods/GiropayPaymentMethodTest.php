...
class GiropayPaymentMethodTest extends BasePaymentMethodTest
{
    ...
    const PAYMENT_METHOD = 'GiropayPaymentMethod';
     ...
     * PaymentObject
     *
     * @var GiropayPaymentMethod $paymentObject
     */
    ...
    public function _before()
    {
        ...
        $paymentMethod = new GiropayPaymentMethod();
    ...
    {
        $timestamp = 'GiropayPaymentMethodTest::authorizeParametersShouldBeSetUpAsExpected 2017-11-22 10:53:43';
        ...
        $expected = [
            ...
            'CRITERION.SECRET' => 'baba73fc2810f325cd4909058fbe26b6026d26e9d7f0f4f9dab4a866cd09bd8ab9caa5dc7211'.
                'b0bd4c3e7bf774d216557be107e727988ab0618d2df8b1235119',
    ...
    {
        $timestamp = 'GiropayPaymentMethodTest::refundParametersShouldBeSetUpAsExpected 2017-11-22 11:06:55';
        $this->paymentObject->getRequest()->basketData(
            $timestamp,
            self::TEST_AMOUNT,
            $this->currency,
        ...
        $expected = [
            ...
            'CONTACT.EMAIL' => $email,
            'CRITERION.PAYMENT_METHOD' => self::PAYMENT_METHOD,
            'CRITERION.SECRET' => 'b8542203826ff6dd9c919ffb8c28c6debcf4c102d51f09cf16f1254e2cf718102a4'.
                '9cb18d75c46433d2d2b06f2c3a14c274b6cf2ae78482244da35253a4cad59',
            'CRITERION.SDK_NAME' => 'Heidelpay\\PhpApi',
            'CRITERION.SDK_VERSION' => '17.9.27',
            'FRONTEND.MODE' => 'WHITELABEL',
