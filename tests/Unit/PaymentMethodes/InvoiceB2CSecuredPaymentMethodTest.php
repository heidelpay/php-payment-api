...
use Heidelpay\PhpApi\PaymentMethodes\InvoiceB2CSecuredPaymentMethod as Invoice;
...
class InvoiceB2CSecuredPaymentMethodTest extends TestCase
{
     ...
     * PaymentObject
     *
     * @var \Heidelpay\PhpApi\PaymentMethodes\InvoiceB2CSecuredPaymentMethod
     */
    ...
    public function Authorize()
    {
        ...
        $this->paymentObject->getRequest()->getName()->set('salutation', 'MRS');
        $this->paymentObject->getRequest()->getName()->set('birthdate', '1982-07-12');
