...
### Added
- Parameter group to allow Online Transfer payments (e.g. EPS and Giropay) without bank selection in shop.
- Example for EPS and Giropay without bank selection.
- PIS/FlexiPay payment method, incl. tests and example.
...
[v1.8.0]: https://github.com/heidelpay/php-payment-api/compare/v1.7.1...v1.8.0
